...
#pragma mark interpreted3 Proxy components
...
- (void)userActivityWillSave:(NSUserActivity *)userActivity
{
  if ([self _hasListeners:@"useractivitywillsave"]) {
    DebugLog(@"[WARN] interpreted3.App.iOS.UserActivity.useractivitywillsave event is deprecated. Update user activity and then set interpreted3.App.iOS.UserActivity.needsSave property to true if you need it to be saved before handing it off to another device.");
